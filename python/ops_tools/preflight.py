...
def build_gateway_config_from_env(*, env_file: str | Path | None = None) -> GatewayConfig:
    ...
    admin_token = os.environ.get("AIMIPAY_ADMIN_TOKEN")
    admin_token_sha256 = os.environ.get("AIMIPAY_ADMIN_TOKEN_SHA256")
    admin_read_token = os.environ.get("AIMIPAY_ADMIN_READ_TOKEN")
    admin_read_token_sha256 = os.environ.get("AIMIPAY_ADMIN_READ_TOKEN_SHA256")
    audit_log_path = os.environ.get("AIMIPAY_AUDIT_LOG_PATH")
