    ...
    release_notes.write_text(
        "\n".join(
            [
                ...
                "- protocol documentation bundle",
                "- self-hosted seller node bundle",
                "- signed seller profile and manifest support",
                "- higher-level purchase workflow APIs",
                "- conformance tooling for live and offline validation",
                "",
                "Compatibility notes:",
                "",
